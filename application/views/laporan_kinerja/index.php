                            ...
                            <div class="card-header">
                                <div class="row">
                                    ...
                                    <div class="col-md-5 mt-4">
                                        <h4> <i class="fa fa-book"></i> KONTRAK LAPORAN KINERJA</h4>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                                        ...
                                                        <table  id="table" class="table-bordered table-striped">
                                                            <thead>
                                                                <tr style="font-size: 12px;" class="bg-primary">
                                                                    ...
                                                                    <th class="text-center bg-primary" style="width:200px;" >Kontrak Manajemen</th>
                                                                    <th class="text-center bg-primary" style="width:100px;" >Departemen</th>
                                                                    <th class="text-center" style="width:100px" >No Kontrak</th>
                                                                    <th class="text-center" style="width:100px" >Tahun Kontrak</th>
                                                                    <th class="text-center" style="width:100px" >Tahun Anggaran</th>
                                                                    <th class="text-center" style="width:100px" >Jenis Kontrak</th>
