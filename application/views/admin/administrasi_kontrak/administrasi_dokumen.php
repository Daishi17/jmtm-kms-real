                                                        ...
                                                        <tbody>
                                                            ...
                                                            foreach ($get_mata_anggaran as $key => $value) { ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="tg-0pky">
                                                                        <a href="<?= base_url('administrasi_kontrak/administrasi_kontrak/kelola_format_dokumen/') . $value['id_detail_program_penyedia_jasa'] ?>" class="btn btn-sm btn-primary btn-block"><i class="fas fa fa-file"></i> Kelola Format Dokumen</a>
                                                                    </td>
